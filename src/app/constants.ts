...
export const SAVE_NOT_READY_MESSAGE = 'Сохранение пока недоступно.';
...
export const INVALID_SAVE_FORMAT_MESSAGE =
  'Некорректный формат сохранения. Доступны png, jpg и gb7.';
